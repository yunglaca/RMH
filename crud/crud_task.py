from utils.task import create_task_in_db,get_all_tasks, get_tasks_by_user, update_task_in_db, delete_task_in_db
...
async def delete_task(task_id: int, db: db_dependency):
    ...
    Возвращает статус 204, если задача успешно удалена.
